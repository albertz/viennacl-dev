...
\
    ...
    VIENNACL_GENERATE_BINARY_ELEMENTOPERATION_OVERLOADS(greater_than)
    VIENNACL_GENERATE_BINARY_ELEMENTOPERATION_OVERLOADS(less_than)
    VIENNACL_GENERATE_BINARY_ELEMENTOPERATION_OVERLOADS(greater_than_equal_to)
    VIENNACL_GENERATE_BINARY_ELEMENTOPERATION_OVERLOADS(less_than_equal_to)
#endif
